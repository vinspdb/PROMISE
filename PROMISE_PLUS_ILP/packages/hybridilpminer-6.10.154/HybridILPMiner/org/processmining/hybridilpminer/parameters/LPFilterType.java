...
public enum LPFilterType {
	...
	NONE("None", 0.0, "No filter."), SEQUENCE_ENCODING("Sequence Encoding Filter", 0.25,
			"Specifies at what level a branch should be \"cut off\"."), SLACK_VAR("Slack Variable Filter", 0.25,
